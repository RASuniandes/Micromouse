...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, ExternalLED_Pin|FL_Emitter_Pin|R_Emitter_Pin|L_Emitter_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(FR_Emitter_GPIO_Port, FR_Emitter_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : InternalLED_Pin */
  ...
  /*Configure GPIO pins : ExternalLED_Pin FL_Emitter_Pin R_Emitter_Pin L_Emitter_Pin */
  GPIO_InitStruct.Pin = ExternalLED_Pin|FL_Emitter_Pin|R_Emitter_Pin|L_Emitter_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
